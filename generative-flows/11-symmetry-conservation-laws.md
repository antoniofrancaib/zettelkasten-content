...
## 11.1 The Principle of Equivariance
...
## 11.2 Group Actions on Molecular Data
...
## 11.3 Equivariant Neural Architectures
...
> [!definition] 11.2 — Neural Conservation Law
...
## 11.5 Divergence-Free and Curl-Free Decompositions
...
> [!theorem] 11.1 — Helmholtz Decomposition
...
> [!remark] 11.2
> For generative modeling, the curl-free component does the work of transforming $p_0$ into $p_1$ (it must change the density), while the divergence-free component is "free" — it can be added without affecting the marginal distributions. This is the formal statement of the observation from Chapter 4 that the continuity equation admits infinitely many velocity fields: they differ by divergence-free perturbations. The minimum-norm velocity field (the Benamou-Brenier minimizer) has zero divergence-free component — it is pure gradient flow.
...
## 11.6 Symplectic Flows and Hamiltonian Structure
...
> [!definition] 11.3 — Symplectic Flow
...
This is particularly relevant for molecular dynamics applications (Chapter 3 of the Molecular Simulation monograph), where the true dynamics are Hamiltonian and the generative model should respect this structure. A non-symplectic generative flow on phase space will produce samples that violate energy conservation, potentially generating unphysical configurations.

## 11.7 Constraint Manifolds and Projected Flows
...
## 11.8 When to Constrain and When to Learn
